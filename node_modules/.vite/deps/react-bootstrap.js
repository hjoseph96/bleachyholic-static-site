...
import {
  ...
  useMounted,
  usePrevious
} from "./chunk-EXJAVIAB.js";
import {
  useUncontrolled,
  useUncontrolledProp
} from "./chunk-YNMPJU76.js";
import {
  require_browser
} from "./chunk-ZIVIJXHD.js";
...
} from "./chunk-JFZUXE6V.js";
import {
  useEventCallback
} from "./chunk-ZFMBF37J.js";
import "./chunk-YNXFVPRA.js";
import {
  DEFAULT_BREAKPOINTS,
  ...
  useBootstrapPrefix,
  useIsRTL
} from "./chunk-XLPQNIE6.js";
import "./chunk-PFYC4RTG.js";
import "./chunk-2IBGICR5.js";
import {
  require_prop_types
...
var CloseButton = React4.forwardRef(({
  className,
  variant,
...
var Button = React7.forwardRef(({
  ...
  return (0, import_jsx_runtime8.jsx)(Component2, {
    ...
    ref,
    disabled,
    className: (0, import_classnames7.default)(className, prefix, active && "active", variant && `${prefix}-${variant}`, size2 && `${prefix}-${size2}`, props.href && disabled && "disabled")
  });
});
...
var ButtonGroup = React8.forwardRef(({
  ...
  return (0, import_jsx_runtime9.jsx)(Component2, {
    ...
    ref,
    role,
    className: (0, import_classnames8.default)(className, baseClass, size2 && `${prefix}-${size2}`)
  });
});
...
var CardHeader = React12.forwardRef(({
  ...
  return (0, import_jsx_runtime13.jsx)(CardHeaderContext_default.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime13.jsx)(Component2, {
      ref,
      ...props,
...
var CardImg = React13.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  ({
    bsPrefix,
    className,
...
var CardImgOverlay = React14.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var CardLink = React15.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "a",
  ...props
...
var CardSubtitle = React16.forwardRef(({
  className,
  bsPrefix,
...
var CardText = React17.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "p",
  ...props
...
var Card = React19.forwardRef(({
  ...
  return (0, import_jsx_runtime20.jsx)(Component2, {
    ...
    children: body ? (0, import_jsx_runtime20.jsx)(CardBody_default, {
      children
    }) : children
  });
});
...
function useUpdateEffect(fn2, deps) {
  const isFirst = (0, import_react4.useRef)(true);
...
function forEach(children, func) {
  ...
  React23.Children.forEach(children, (child) => {
    if (React23.isValidElement(child)) func(child, index++);
  });
}
...
var Container = React26.forwardRef(({
  ...
  return (0, import_jsx_runtime28.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames25.default)(className, fluid ? `${prefix}${suffix}` : prefix)
  });
});
...
function useDropdownMenu(options = {}) {
  const context2 = (0, import_react13.useContext)(DropdownContext_default);
...
var DropdownDivider = React33.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "hr",
  role = "separator",
...
var DropdownHeader = React34.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  role = "heading",
...
var DropdownItemText = React36.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "span",
  ...props
...
var useIsomorphicEffect_default2 = isDOM || isReactNative ? import_react18.useLayoutEffect : import_react18.useEffect;
...
var context = React37.createContext(null);
...
var FormGroup = React53.forwardRef(({
  ...
  const context2 = (0, import_react27.useMemo)(() => ({
    controlId
  }), [controlId]);
...
var Switch = React58.forwardRef((props, ref) => (0, import_jsx_runtime59.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
function useCallbackRef2() {
  return (0, import_react32.useState)(null);
}
...
function useRTGTransitionProps(_ref) {
  ...
  const handleEnter = (0, import_react36.useCallback)(normalize(onEnter), [onEnter]);
  const handleEntering = (0, import_react36.useCallback)(normalize(onEntering), [onEntering]);
  const handleEntered = (0, import_react36.useCallback)(normalize(onEntered), [onEntered]);
  const handleExit = (0, import_react36.useCallback)(normalize(onExit), [onExit]);
  const handleExiting = (0, import_react36.useCallback)(normalize(onExiting), [onExiting]);
  const handleExited = (0, import_react36.useCallback)(normalize(onExited), [onExited]);
  const handleAddEndListener = (0, import_react36.useCallback)(normalize(addEndListener), [addEndListener]);
  return Object.assign({}, props, {
    ...
    ) : (0, import_react36.cloneElement)(children, {
      ref: mergedRef
    })
  });
}
...
var RTGTransition = React65.forwardRef((_ref, ref) => {
  let {
...
var Modal = (0, import_react38.forwardRef)((_ref, ref) => {
  ...
  return (0, import_jsx_runtime69.jsx)(import_jsx_runtime69.Fragment, {
    children: import_react_dom.default.createPortal((0, import_jsx_runtime69.jsxs)(import_jsx_runtime69.Fragment, {
...
var ModalFooter = React71.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var AbstractModalHeader = React72.forwardRef(({
  closeLabel = "Close",
  closeVariant,
  closeButton = false,
  onHide,
  ...
  const context2 = (0, import_react39.useContext)(ModalContext_default);
...
var NavbarCollapse = React77.forwardRef(({
  ...
  const context2 = (0, import_react41.useContext)(NavbarContext_default);
...
var OffcanvasBody = React79.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var OffcanvasToggling = React80.forwardRef(({
  bsPrefix,
  className,
  children,
  in: inProp = false,
  ...
  return (0, import_jsx_runtime82.jsx)(TransitionWrapper_default, {
    ...
    children: (status, innerProps) => React80.cloneElement(children, {
      ...innerProps,
...
var OffcanvasHeader = React81.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
...
var OffcanvasTitle = React82.forwardRef(({
  className,
  bsPrefix,
...
var Offcanvas = React83.forwardRef(({
  bsPrefix,
  className,
  children,
  "aria-labelledby": ariaLabelledby,
  ...
  const renderBackdrop = (0, import_react45.useCallback)((backdropProps) => (0, import_jsx_runtime85.jsx)("div", {
    ...backdropProps,
...
var NavbarOffcanvas = React84.forwardRef(({
  onHide,
  ...props
}, ref) => {
  const context2 = (0, import_react46.useContext)(NavbarContext_default);
...
var NavbarText = React85.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "span",
  ...props
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime102.jsxs)(import_jsx_runtime101.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react52.cloneElement)(children, triggerProps), (0, import_jsx_runtime100.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
function createButton(name, defaultValue, label = name) {
  const Button2 = React96.forwardRef(({
    children,
    ...props
...
function renderTab(child) {
  ...
  return (0, import_jsx_runtime116.jsx)(NavItem_default, {
    as: "li",
    role: "presentation",
...
var ToastFade = React108.forwardRef((props, ref) => (0, import_jsx_runtime118.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastHeader = React110.forwardRef(({
  ...
  const context2 = (0, import_react54.useContext)(ToastContext_default);
  const handleClick = useEventCallback2((e) => {
