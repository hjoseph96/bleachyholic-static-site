...
function Paginator(props) {
  ...
  const [state, setState] = (0, import_react.useState)(() => init());
  const firstRun = (0, import_react.useRef)(true);
  const gotoPage = (0, import_react.useCallback)((page) => {
    const currentPage2 = Math.max(1, Math.min(page, state.totalPages));
    props.setCurrentPage(currentPage2);
  ...
  const handleMoveLeft = (0, import_react.useCallback)((evt) => {
    evt.preventDefault();
    gotoPage(props.currentPage - state.pageNeighbours * 2 - 1);
  }, [props.currentPage]);
  const handleMoveRight = (0, import_react.useCallback)((evt) => {
    evt.preventDefault();
    gotoPage(props.currentPage + state.pageNeighbours * 2 + 1);
  }, [props.currentPage, state.pageNeighbours]);
  const fetchPageNumbers = (0, import_react.useCallback)(() => {
    ...
    if (totalPages > totalBlocks) {
      let pages2 = [];
      const leftBound = currentPage2 - pageNeighbours;
      const rightBound = currentPage2 + pageNeighbours;
      const beforeLastPage = totalPages - 1;
      const startPage = leftBound > 2 ? leftBound : 2;
      const endPage = rightBound < beforeLastPage ? rightBound : beforeLastPage;
      pages2 = range(startPage, endPage);
      const pagesCount = pages2.length;
      ...
      if (leftSpill && !rightSpill) {
        ...
        pages2 = [leftSpillPage, ...extraPages, ...pages2];
      } else if (!leftSpill && rightSpill) {
        const extraPages = range(endPage + 1, endPage + singleSpillOffset);
        pages2 = [...pages2, ...extraPages, rightSpillPage];
      } else if (leftSpill && rightSpill) {
        pages2 = [leftSpillPage, ...pages2, rightSpillPage];
      }
  ...
  return import_react.default.createElement("ul", {
    ...
    if (page === LEFT_PAGE) return import_react.default.createElement("li", {
    ...
    if (page === RIGHT_PAGE) return import_react.default.createElement("li", {
      className: props.pageItemClass,
      key: index
    }, import_react.default.createElement("button", {
...
Paginator.propTypes = {
  currentPage: propTypesExports.number,
  pageActiveClass: propTypesExports.string,
  pageNextText: propTypesExports.oneOfType([propTypesExports.string, propTypesExports.node]),
  pagePrevText: propTypesExports.oneOfType([propTypesExports.string, propTypesExports.node]),
  pagePrevClass: propTypesExports.string,
  pageNextClass: propTypesExports.string,
  pageContainerClass: propTypesExports.string,
  pageItemClass: propTypesExports.string,
  pageLimit: propTypesExports.number,
  pageLinkClass: propTypesExports.string,
  pageNeighbours: propTypesExports.number,
  setCurrentPage: propTypesExports.func,
  setOffset: propTypesExports.func,
  totalRecords: propTypesExports.number.isRequired
};
export {
...
react-hooks-paginator/dist/index.esm.js:
...
react-hooks-paginator/dist/index.esm.js:
  ...
  *)
*/
//# sourceMappingURL=react-hooks-paginator.js.map
